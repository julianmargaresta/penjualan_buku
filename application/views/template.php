  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?=base_url('index.php/admin/data_diri')?>" class="btn btn-default btn-flat">Profile</a>
                </div>
        ...
        <?php else: ?>
          <li class="dropdown user user-menu">
            <a href="<?=base_url('index.php/login')?>" class="dropdown-toggle">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="<?=base_url()?>index.php/admin"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
        <li><a href="<?=base_url()?>index.php/kategori"><i class="fa fa-circle"></i> <span>Kategori</span></a></li>
        <li><a href="<?=base_url()?>index.php/buku"><i class="fa fa-circle"></i> <span>Daftar Barang</span></a></li>
        
        <li><a href="<?=base_url()?>index.php/pesanan"><i class="fa fa-circle"></i> <span>Histori Pesanan</span></a></li>
        <li><a href="<?=base_url()?>index.php/transaksi"><i class="fa fa-circle"></i> <span>Transaksi</span></a></li>
